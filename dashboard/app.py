...
if 'api_url' not in st.session_state:
    st.session_state.api_url = os.getenv('TEST_ANALYZER_API_URL', 'http://localhost:8000')
...
try:
    ...
    with tab1:
        st.info("Overview page module not found. Please ensure all page modules are installed.")
...
# Footer
st.divider()
st.caption(f"Test Report Analyzer Dashboard • Last updated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
